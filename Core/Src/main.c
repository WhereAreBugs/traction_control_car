...
//        printf("开始处理数据");
        ...
        {
            if (strstr(RxBuffer, "stop#")) { // NOLINT(bugprone-branch-clone)
                //执行停止-推荐让speed为0

            }
            else if (strstr(RxBuffer, "setKP")) {
                //修改PID参数-比例系数
...
//                    printf("数据错误\n");
            ...
            } else if (strstr(RxBuffer, "setSpeed")) {
                //修改速度
